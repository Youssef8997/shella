...
import '../features/location/screens/map_parcel_screen.dart';
import '../features/menu/screens/static_screen.dart';
import '../features/package/screen/package_screen.dart';
...
class RouteHelper {
  ...
  static const String parcelRequestMap = '/parcel-requesta-map';
  ...
  static String getStaticRoute(String page) => '$static?page=$page';

  static String getOnBoardingRoute() => onBoarding;
  static String getPackagesRoute() => packages;
  ...
  static String getSearchRoute({String? queryText,List<int>categoryIds=const []}) =>
  ...
  static String getParcelRequestMapRoute(ParcelCategoryModel category,
      AddressModel pickupAddress, AddressModel destinationAddress) {
    String category0 =
    base64Url.encode(utf8.encode(jsonEncode(category.toJson())));
    String pickedUpAddress =
    ...
    String destinationAddress0 =
    base64Url.encode(utf8.encode(jsonEncode(destinationAddress.toJson())));
    return '$parcelRequestMap?category=$category0&picked=$pickedUpAddress&destination=$destinationAddress0';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: packages, page: () => const PackageScreen()),
    GetPage(
        name: signIn,
        page: () => SignInScreen(
    ...
    GetPage(
        name: parcelRequestMap,
        page: () => getRoute(MapParcelScreen(

              address: AddressModel.fromJson(jsonDecode(utf8.decode(
                  base64Url.decode(
                      Get.parameters['picked']!.replaceAll(' ', '+'))))),
