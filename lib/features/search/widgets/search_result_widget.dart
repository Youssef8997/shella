...
ScrollController scrollController=ScrollController();
  @override
  void initState() {
    Get.find<search.SearchController>().querySearch=widget.searchText;
    Get.find<search.SearchController>().offsetSearch=1;
    super.initState();
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        Get.find<search.SearchController>().searchData(widget.searchText, true);
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Expanded(child: NotificationListener(
        ...
        child: TabBarView(
          controller: _tabController,
          children:  [
            ItemViewWidget(isItem: false,scrollController: scrollController,),
