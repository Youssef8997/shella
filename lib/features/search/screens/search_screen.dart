...
class SearchScreen extends StatefulWidget {
  ...
  const SearchScreen({super.key, required this.queryText, this.categoryIds});
                            ...
                            margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                             padding: const EdgeInsets.symmetric(horizontal : Dimensions.paddingSizeDefault),
                              ...
                              child: InkWell(
                                ...
                                child: Row(
                                  children: [
                                    Text(searchController.historyList[index], style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis),
                                    InkWell(
                                ...
                                child: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: robotoBold.copyWith(color: !Get.isDarkMode?Colors.black:Colors.white),
