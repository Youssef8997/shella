                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Row(children: [
                        Text('min_order_delivery'.tr, style: robotoRegular),
                        const Expanded(child: SizedBox()),
                        Text(
                          order.minTimeDelivery??"",
                          style: robotoRegular,
                        ),
                      ]),
                      Divider(
                      ...
                      Row(children: [
                        Text('max_order_delivery'.tr, style: robotoRegular),
                        const Expanded(child: SizedBox()),
                        Text(
    order.maxTimeDelivery??"",
                          style: robotoRegular,
                        ),
                      ]),
                    ],
                  ...
                  Row(children: [
                    ...
                    Text("typeOfOrder".tr, style: robotoMedium),
                    const Expanded(child: SizedBox()),
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        vertical: Dimensions.paddingSizeExtraSmall),
                    child: Row(children: [
                      Text('${parcel ? 'charge_pay_by'.tr : 'status'.tr}:',
                          style: robotoRegular),
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.separated(
                                              itemBuilder: (context, i) => Row(
                                                    children: [
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "${order.orderRequests![i].deliveryMan.fName!} ${order.orderRequests![i].deliveryMan.lName!}",
                                                            style:
                                                                robotoRegular,
                                                          ),
                                                          Text(
                                                            "السعر المقدم هوا ${order.orderRequests![i].price} ${Get.find<SplashController>().configModel!.currencySymbol}",
                                              ...
                                              itemCount: (order.orderRequests
                                                          ?.isNotEmpty ??
                                                      false)
                                                  ? order.orderRequests!.length
                                                  : 0),
                                        )
                                      ],
                                    )
          ...
          (isDesktop &&
                  ...
                  order.orderAttachmentFullUrl != null &&
                  order.orderAttachmentFullUrl!.isNotEmpty)
              ? Text(order.moduleType=="parcel"?"التفاصيل":'prescription'.tr, style: robotoMedium)
              : const SizedBox(),
          ...
          (Get.find<SplashController>()
              ...
              ? Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        !isDesktop
                            ? Text(order.moduleType=="parcel"?"التفاصيل":'prescription'.tr, style: robotoRegular)
                            : const SizedBox(),
                        !isDesktop
                            ? const SizedBox(
                                height: Dimensions.paddingSizeSmall)
                        ...
                        SizedBox(
                          child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                if(order.orderAttachmentFullUrl![index]!.isVideoFileName){
                                  return VideoApp(videoPath:order.orderAttachmentFullUrl![index]! ,);
                                }else{
                                  return Padding(
          ...
          (parcel && isDesktop)
              ...
              : const SizedBox(),
          if (order.moduleId == 8 && order.deliveryMan == null && isDesktop)
            Container(
              decoration: BoxDecoration(
                color: Theme.of(context).cardColor,
                borderRadius: BorderRadius.circular(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    Get.find<OrderController>()
                                        .acceptRequest(
                                            order.orderRequests![i].id
                                                .toString(),
                                            order.orderRequests![i].orderId
                                                .toString())
                                        .then((value) {
                        ...
                        itemCount: (order.orderRequests?.isNotEmpty ?? false)
                            ? order.orderRequests!.length
                            : 0),
                  )
                ],
