        ...
        builder: (orderController) {
          return SizedBox(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
if(orderController.cancelReason=="اخري"||orderController.cancelReason=="other")
  CustomTextField(
    labelText: 'اكتب سببك',
    titleText: 'علي سبيل المثال:طلبت الطلب بدون عمد ',
controller: reson,
              ...
              Padding(
                ...
                child: !orderController.isLoading ? Row(children: [
                  ...
                  Expanded(child: CustomButton(
                    ...
                    onPressed: (){
                      if(reson.text.isNotEmpty){
                        orderController.cancelOrder(widget.orderId, reson.text).then((success) {
                          if(success){
