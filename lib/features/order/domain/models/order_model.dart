...
class PaginatedOrderModel {
  ...
  List<OrderModel>? collectedOrder;

  PaginatedOrderModel({this.totalSize, this.limit, this.offset, this.orders,this.collectedOrder});
  ...
  PaginatedOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['orders'] != null) {
      ...
      json['orders'].forEach((v) {
        if(v["collection_order"]){
          if(v["collections_order"]!=null&&v["collections_order"].isNotEmpty){
    ...
    if (json['orders'] != null&&json['orders'].isNotEmpty) {
      collectedOrder = [];

      json['orders'].forEach((v) {
        if(v["collections_order"]!=null&&v["collections_order"].isNotEmpty){
          if(v["collection_order"]){
            if(v["collections_order"].isEmpty){
              collectedOrder!.add(OrderModel.fromJson(v));
            }
...
class OrderModel {
  ...
  String? delivered;
  String? canceled;
  String? minTimeDelivery;
  String? maxTimeDelivery;
  ...
  bool? isCollectionOrder;
  List? collectionsOrders;
  ...
  OrderModel({
    ...
    this.paymentStatus,
    this.collectionsOrders,
    this.orderStatus,
    this. minTimeDelivery,
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    orderRequests = json["order_requests"] != null
        ? List.generate(json["order_requests"].length,
            (i) => OrderRequestModel.fromJson(json["order_requests"][i]))
        : [];
    ...
    isCollectionOrder = json['collection_order'];
    collectionsOrders = json['collections_order'];
    minTimeDelivery = json['min_delivery_time'];
    maxTimeDelivery = json['max_delivery_time'];
