...
import 'delivery_instruction_bottom_sheet_widget.dart';
...
class ParcelViewWidget extends StatefulWidget {
  ...
  const ParcelViewWidget({super.key, required this.isSender, required this.nameController, required this.phoneController,
    required this.streetController, required this.houseController, required this.floorController, required this.bottomButton, required this.countryCode, required this.areaController});
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(Get.find<SplashController>().module!.id == 8?"معلومات طالب الخدمه ":widget.isSender ? 'pickup_location'.tr : 'delivery_location'.tr, style: robotoMedium),
...
SizedBox(height: 20,),
                          ...
                          child: CustomDropdown<int>(
                            onChange: (int? value, int index) async {
                              ...
                              if(parcelController.isSender){
                                ...
                                widget.areaController.text = senderAddress[index].additionalAddress ?? '';
                                ...
                                widget.areaController.text = receiverAddress[index].additionalAddress ?? '';
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(Get.find<SplashController>().module!.id == 8?"conniction_info".tr:parcelController.isSender ? 'sender_information'.tr : 'receiver_information'.tr, style: robotoMedium),
                        const SizedBox(height: Dimensions.paddingSizeDefault),

                        CustomTextField(
                          labelText: Get.find<SplashController>().module!.id == 8?"name_connection".tr:parcelController.isSender ? 'sender_name'.tr : 'receiver_name'.tr,
                          titleText: Get.find<SplashController>().module!.id == 8?"name_connection".tr:parcelController.isSender ? 'sender_name'.tr : 'receiver_name'.tr,
                        ...
                        CustomTextField(
                          titleText:Get.find<SplashController>().module!.id == 8? "phone_number".tr:parcelController.isSender ? 'sender_phone_number'.tr : 'receiver_phone_number'.tr,
                          labelText: Get.find<SplashController>().module!.id == 8? "phone_number".tr:parcelController.isSender ? 'sender_phone_number'.tr : 'receiver_phone_number'.tr,
