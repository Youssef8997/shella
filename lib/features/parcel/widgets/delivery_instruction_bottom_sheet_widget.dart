                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          Get.find<ParcelController>().file =
                              await image.pickMedia();
                        ...
                        child: Container(
                          ...
                          child: Get.find<ParcelController>().file == null
                              ? Icon(
                                  Icons.add,
                                  color: Colors.grey,
                                  size: 22,
                      ...
                      Row(
                        children: [
                          parcelController.parcelInstructionList!.isNotEmpty
                              ...
                              : const SizedBox(),
                          SizedBox(
                              width: parcelController
                                      .parcelInstructionList!.isNotEmpty
