  ...
  void initState() {
    ...
    if (Get.find<SplashController>().module?.id == 8) {
      Get.find<SplashController>()
          .getSubModules(id: Get.find<SplashController>().module?.id);
    }
            ...
            RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                child: iscategory
                    ...
                    :Get.find<SplashController>().module?.id==8?FooterView(
                    child: SizedBox(
                        width: Dimensions.webMaxWidth,
                        child:isStores? SubModelsWidget():Column(
                            crossAxisAlignment:
                            ResponsiveHelper.isDesktop(context)
                                ? CrossAxisAlignment.center
                                : CrossAxisAlignment.start,
                            children: [
                              ...
                              Text(" اختر الخدمه المفضله لك ؟",style: robotoBold,),
                              GridView.builder(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: CustomImage(
                                                image:
                                                "https://shalafood.net/storage/app/public/module/2024-10-06-67024b63427ab.png",
                                                height: 75,
                                                width: 110,
                                              ),
                                            ),
                                            ...
                                            Center(
                                                child: Text(
                                                 index==1? "حدمات الشركات":"خدمات الافراد",
...
class SubModelsWidget extends StatefulWidget {
  const SubModelsWidget({super.key});

  @override
  State<SubModelsWidget> createState() => _SubModelsWidgetState();
}

class _SubModelsWidgetState extends State<SubModelsWidget> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (splashController) {
      return splashController.subModuleList?.isNotEmpty == true &&
              Get.find<SplashController>().module?.id == 8
          ? Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('اختر نوع منتجات الشراء',
                    style: robotoBold.copyWith(
                        fontSize: Dimensions.fontSizeLarge)),
                GridView.builder(
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                  itemCount: splashController.subModuleList!.length,
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: CustomInkWell(
                        onTap: () {
                          ...
                          splashController.switchSubModule(index, true);
                        },
                        radius: Dimensions.radiusDefault,
                        child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              ClipRRect(
                                ...
                                child: CustomImage(
                                  image:
                                      '${splashController.subModuleList![index].iconFullUrl}',
                                  height: 75,
                                  width: 110,
                                ),
                              ),
                              ...
                              Center(
                                  child: Text(
                                splashController
                                    .subModuleList![index].moduleName!,
                                textAlign: TextAlign.center,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: robotoMedium.copyWith(
          ...
          : Center(child: Text('no_module_found'.tr));
    });
  }
}
