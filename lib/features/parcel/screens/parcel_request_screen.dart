...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title:Get.find<SplashController>().module!.id == 8?" اخدمني":'parcel_request'.tr),
                                ...
                                children: [
                                  ...
                                  CardWidget(
                                      child: Column(
                                          ...
                                          children: [
                                        DetailsWidget(
                                            title: Get.find<SplashController>().module!.id == 8?"تفاصيل الخدمه":'sender_details'.tr,
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                      child: PaymentButton(
                                        icon: Images.parcel,
                                        title: 'pay_with_package'.tr,
                                        subtitle:
                                            'faster_and_secure_way_to_pay_bill'
                                                .tr,
                                        isSelected:
                                            parcelController.paymentIndex == 4,
                                        onTap: () => parcelController
                                            .setPaymentIndex(4, true),
                                      ),
                                    ),
                                    SizedBox(
                                  ...
                                  Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                                        if (parcelController.paymentIndex == 4)
                                          Text('kmSubsFromUrPackage'.tr,
                                              style: robotoMedium),
                                        if (parcelController.paymentIndex == 4)
                                          Text(
                                            parcelController.distance == -1
  ...
  Widget _bottomButton(ParcelController parcelController, double charge) {
    ...
    return CustomButton(
      buttonText:Get.find<SplashController>().module!.id == 8? "confirm_service_order".tr :'confirm_parcel_request'.tr,
          ...
          ? () {
              if (parcelController.distance == -1) {
                ...
                PlaceOrderBodyModel placeOrderBody = PlaceOrderBodyModel(
                  ...
                  paymentMethod: parcelController.paymentIndex == 4
                      ? "package"
                ...
                if (parcelController.paymentIndex == 3) {
                  ...
                  parcelController.placeOrder(placeOrderBody,
                      ...
                      orderAttachment:Get.find<ParcelController>().file!=null? [Get.find<ParcelController>().file!]:null,
                      forParcel: true);
                }
              }
            }
