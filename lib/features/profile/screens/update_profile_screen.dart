...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ProfileController>(builder: (profileController) {
        ...
        if(profileController.userInfoModel != null && _phoneController.text.isEmpty) {
          ...
          _thirdNameController.text = profileController.userInfoModel!.tName ?? '';
  ...
  void _updateProfile(ProfileController profileController) async {
    ...
    if (profileController.userInfoModel!.fName == firstName &&profileController.userInfoModel!.tName == _thirdNameController.text.trim()&&
      ...
      UserInfoModel updatedUser = UserInfoModel(fName: firstName, tName: _thirdNameController.text.trim(),lName: lastName, email: email, phone: phoneNumber);
