...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    ...
    Get.find<ItemController>().init();
    Get.find<StoreController>().init();
    Get.find<CategoryController>().init();
    ...
    if (Get.find<SplashController>().module != null &&
        !Get.find<SplashController>()
            ...
            .moduleConfig!
            .module!
            .isParcel!&&Get.find<SplashController>().module?.id!=3) {
      Future.wait([
      Get.find<BannerController>().getBannerList(reload),
        ...
        Get.find<ItemController>().getFeaturedCategoriesItemList(reload, false),
        Get.find<FlashSaleController>().getFlashSale(reload, false),
        Get.find<BrandsController>().getBrandList(),
        Get.find<ItemController>().getDiscountedItemList(reload, true, 'all'),
        Get.find<CampaignController>().getBasicCampaignList(reload),
        Get.find<CampaignController>().getItemCampaignList(reload),
        Get.find<HomeController>().getList(),
      ]);
