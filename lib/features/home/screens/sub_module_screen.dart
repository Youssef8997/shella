...
class SubModuleScreen extends StatelessWidget {
  ...
  const SubModuleScreen({super.key, required this.splashController});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        splashController.subModuleList != null
            ? splashController.subModuleList!.isNotEmpty
            ? GridView.builder(
              ...
              child: CustomInkWell(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Center(
                          child: Text(
                            splashController.subModuleList![index].moduleName!,
