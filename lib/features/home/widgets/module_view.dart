...
import '../screens/sub_module_screen.dart';
              ...
              ? GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: CustomInkWell(
                        onTap: () {
                          if(splashController.moduleList![index].isCollection==true){
                            splashController.getSubModules(id: splashController.moduleList![index].id);
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>SubModuleScreen(splashController: splashController,)));
                          }else{
