...
class AuthController extends GetxController implements GetxService {
  ...
  Future<void> getPacakages() async {
    package = await authServiceInterface.getPackages() ?? [];
    update();
  }

  Future<void> subscribePacakages(int id) async {
    _isLoading = true;
    update();
    ResponseModel responseModel =
        await authServiceInterface.subscribePacakages(id);
    if (responseModel.isSuccess) {
      showCustomSnackBar("subscribePackageSuccess".tr, isError: false);
    }
    _isLoading = false;
    update();
  }
