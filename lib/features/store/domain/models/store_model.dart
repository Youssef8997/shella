...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    is_subscription = json['is_subscription']==1?true:false;
    try{
      if(json['is_subscription']==0){
        categoryIdsss=List<int>.from(jsonDecode(json["category_idsss"]));
      ...
      categoryIdsss=json["category_idsss"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['email'] = email;
    data['busy'] = busy;
    data["is_subscription"]= is_subscription==true?1:0;
    data['logo_full_url'] = logoFullUrl;
    data["categoryIdsss"]=categoryIdsss;
