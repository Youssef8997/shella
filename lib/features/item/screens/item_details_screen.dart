...
import '../../home/widgets/components/review_item_card_widget.dart';
...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  void initState() {
    ...
    Get.find<StoreController>().getRelatedItem(widget.item!.id!);
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                itemController.item!
                                                    ...
                                                    : const SizedBox(),
                                                SizedBox(height: context.height*.3,width: context.width,
                                                  child: ListView.separated(
                                                    ...
                                                    return ReviewItemCard(
                                                      item: Get.find<StoreController>().relatedProducts![i],
                                                    );
                                                  }, separatorBuilder: (context,_){
                                                    return SizedBox(width: 20,);
                                                  }, itemCount:  Get.find<StoreController>().relatedProducts?.length??0),
                                                ),
                                              ],
                                            ))))),
                                                  ...
                                                  if (itemController.item!
                                                    ...
                                                    if (cartController.existAnotherStoreItem(
                                                      ...
                                                      if (itemController.cartIndex ==
                                                          -1) {
                                                        if(Get.find<SplashController>().module?.id!=3){
                                                          showModalBottomSheet(context: context, constraints: BoxConstraints(
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                SizedBox(height: 20,),
                                                                Text("هناك اسعار افضل لهذا المنتج!",style: robotoBold.copyWith(fontSize: 20),),
                                                                SizedBox(height: 20,),
                                                                Text("هل تريد مشاهده كل العروض علي هذا المنتج؟",style: robotoBold.copyWith(color: Colors.grey,fontSize: 16),),
                                                                SizedBox(height: 30,),
                                                                ElevatedButton(onPressed: (){
                                                                  //searchData();
                                      
                                      
                                                                  Get.find<search.SearchController>().setSearchMode(false,canUpdate: true);
                                                                  List<int>categorys=[];
                                      
                                                                  for(CategoryIds category in widget.item?.categoryIds??[]){
                                                                    categorys.add(int.parse(category.id!));
                                                                  }
                                                                  Get.find<search.SearchController>().categoryIds=categorys;
                                      
                                                                  Get.toNamed(
                                                                      RouteHelper.getSearchRoute(queryText:widget.item?.name ));
                                      
                                                                }, child: Text("مشاهده العروض",style: robotoBold.copyWith(color: Colors.white),),style: ButtonStyle(
