...
class WalletRepository implements WalletRepositoryInterface{
  ...
  Future<Response> requestExchange(String number) async {
    Response response = await apiClient.postData(AppConstants.requestExchangeWalletMoney,{
      "userReceiver":number
    });
    return response;
  }
  ...
  Future<Response> exchangeWallet(String number, String otp, String userOtp, String money) async {
    Response response = await apiClient.postData(AppConstants.exchangeWalletMoney,{
      "userReceiver":number,
      "otpUser":otp,
      "otpReceiver":userOtp,
      "walletMoney":money
