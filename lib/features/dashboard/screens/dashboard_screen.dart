...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    if(Get.find<SplashController>().configModel?.videoPopUp!=null){
        ...
        Get.dialog(Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              GetServiceVideoWidget(youtubeVideoUrl: Get.find<SplashController>().configModel!.videoPopUp!, fileVideoUrl: '')
