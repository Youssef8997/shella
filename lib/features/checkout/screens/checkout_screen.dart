...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    super.initState();
Get.find<CheckoutController>().addToInvoice=false;
    initCall();
                                        ...
                                        child: Row(
                                            ...
                                            children: [
                                              ...
                                              PriceConverter
                                                ...
                                                checkoutController.addToInvoice?subTotal:checkoutController
                                                    .viewTotalPrice,
                                                textStyle:
                    ...
                    if (isGuestLogIn &&
                      ...
                      if (widget.storeId == null) {
                        ...
                        PlaceOrderBodyModel placeOrderBody =
                            PlaceOrderBodyModel(
                          cart: carts,
                          collectionOrder: Get.find<CheckoutController>().addToInvoice,
                          mainOrderId:Get.find<CheckoutController>().addToInvoice&&Get.find<CheckoutController>().isFirstOrder? null:Get.find<CheckoutController>().idOfMainOrder,
                        ...
                        log(placeOrderBody.toJson().toString());
                        if (checkoutController.paymentMethodIndex == 3) {
                          ...
                          checkoutController.placeOrder(
                              ...
                              widget.fromCart,
                              _isCashOnDeliveryActive!,
                              orderAttachmentIntraction: checkoutController.intsructionFile,
  ...
  double _calculateOriginalDeliveryCharge(
    ...
    if (store != null && distance != null) {
      ...
      double priceForKMSAfterLimit = (distance -
              Get.find<SplashController>().configModel!.limitForDelivery!) *
          Get.find<SplashController>().configModel!.priceForKMDelivery!;
      if (deliveryCharge < minimumCharge) {
        ...
        deliveryCharge += priceForKMSAfterLimit;
      }
    }
