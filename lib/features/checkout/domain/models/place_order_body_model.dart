...
class PlaceOrderBodyModel {
  ...
  String? get mainOrderId => _mainOrderId;
  bool? get collectionOrder => _collectionOrder;
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    _collectionOrder = json['collection_order'];
    if(_mainOrderId!=null){
      _mainOrderId = json['order_group_id'];
  ...
  Map<String, String> toJson() {
    ...
    if(_mainOrderId!=null){
      data['order_group_id'] = _mainOrderId.toString();

    }
    data['collection_order'] = (_collectionOrder??false)?"1":"0";
