...
class TimeSlotSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      !isGuestLoggedIn && storeId == null && checkoutController.store?.scheduleOrder==true && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Container(
      ...
      SizedBox(height: !isGuestLoggedIn && storeId == null && checkoutController.store?.scheduleOrder==true && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Dimensions.paddingSizeSmall : 0),
