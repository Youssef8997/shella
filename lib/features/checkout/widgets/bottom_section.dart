      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            ( Get.find<CartController>().needExtraPackage) ? Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('extra_packaging'.tr, style: robotoRegular),
                if(checkoutController.store!=null&&checkoutController.store?.extraPackagingStatus==true)
            ...
            SizedBox(height: checkoutController.store?.extraPackagingStatus==true && Get.find<CartController>().needExtraPackage ? Dimensions.paddingSizeSmall : 0.0),

            (AuthHelper.isGuestLoggedIn() && checkoutController.guestAddress == null)
            ? const SizedBox() :Get.find<CheckoutController>().addToInvoice? const SizedBox():Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Get.find<SplashController>().configModel!.additionalChargeStatus!&&Get.find<CheckoutController>().paymentMethodIndex==0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
