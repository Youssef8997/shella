...
class TopSection extends StatelessWidget {
  ...
  const TopSection({
    super.key, required this.deliveryCharge,required this.subTotal, required  this.charge, required this.tomorrowClosed,
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        !takeAway && !isGuestLoggedIn ? Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(
            checkoutController.store?.freeDelivery==true ? 'free'.tr
        ...
        !takeAway ? isDesktop ? const SizedBox() : const DeliveryInstructionViewMedia() : const SizedBox(),
        ...
        Container(
          ...
          child: Column(children: [
            ...
            PaymentSection(
              ...
              isWalletActive: isWalletActive, total: checkoutController.addToInvoice?subTotal:total, checkoutController: checkoutController, isOfflinePaymentActive: isOfflinePaymentActive,
            ),
        ...
        Container(
          ...
          padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeLarge, horizontal: Dimensions.paddingSizeLarge),
          child: Column(children: [
CheckboxListTile(value: checkoutController.addToInvoice, onChanged: (value){
  checkoutController.toggleAddInvoice();
  if(value==true){
    showModalBottomSheet(context: context,isScrollControlled: true, constraints: BoxConstraints(
  ...
  },title: Text("doUWantToAddThisOrderToCollectionOfOrders".tr,style: robotoMedium,textAlign: TextAlign.start,),)
