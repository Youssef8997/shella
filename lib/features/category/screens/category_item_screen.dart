...
bool isSort=false;
  ...
  void initState() {
    ...
    _tabController = TabController(length: Get.find<SplashController>().module?.id==3?1:2, initialIndex: 0, vsync: this);
...
Get.dialog(FilterWidgetCategory(isStore: false,maxValue: maxValue,));
          ...
          body: Center(child: SizedBox(
            ...
            child: Column(
              ...
              Padding(
                ...
                child: Text(
                  "${'results_found'.tr} : ${catController.pageSize??0}",
