...
class ConfigModel {
  ...
  double? limitForDelivery;
  double? priceForKMDelivery;
  double? priceForStop;
  ConfigModel({
    this.businessName,
    this.logoFullUrl,
    this.priceForKMDelivery,
    this.limitForDelivery,
    this.address,
    this.phone,
    this.videoPopUp,
    this.email,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    videoPopUp = json['videoPopUp'];
    limitForDelivery = double.parse(json['limit_for_delevry'].toString());
    priceForKMDelivery = double.parse(json['price_after_limit'].toString());
    address = json['address'];
    phone = json['phone'];
    priceForStop = double.parse(json['stop_price'].toString());
    email = json['email'];
