...
class AppConstants {
  static const String appName = 'Food shala';
  static const double appVersion = 2.8;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://shalafood.net';
  ...
  static const String staticItemUri = '/api/v1/customer/order/listItem';
  ...
  static const String subModuleUri = '/api/v1/SubModule';
  ...
  static const String acceptRequestUri = '/api/v1/customer/order/accept';
  ...
  static const String relatedItems = '/api/v1/items/related-items';
  ...
  static const String subscriptionsUri =
      '/api/v1/customer/package/subscriptions';
  static const String subscribeUri = '/api/v1/customer/package/subscription';
  ...
  /// Cart
  static const String getCartListUri = '/api/v1/customer/cart/lists';
